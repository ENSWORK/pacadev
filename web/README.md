...
```env
DATABASE_URL=file:/home/pacadev/pacadev/web/db/custom.db

# Chemins absolus — nécessaires car bun snap utilise un HOME différent
PACADEV_HOME=/home/pacadev/.pacadev
PACADEV_WORKSPACE=/home/pacadev/pacadev
...
> ⚠️ Ne jamais modifier les scripts CLI PACADEV (`/home/pacadev/pacadev/core/cli/`). Uniquement la couche `web/`.
