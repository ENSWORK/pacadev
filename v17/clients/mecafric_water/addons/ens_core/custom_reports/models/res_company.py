...
class ResCompany(models.Model):
    ...
    stamp_image = fields.Binary(
        ...
        help="Image du tampon ou cachet de la société pour les factures MEC. "
        "Format recommandé : PNG avec fond transparent, 300x150px. "
        "Utilisée avec l'option 'Imprimer avec signature' sur les factures. "
        "Prioritaire sur la signature utilisateur si définie.",
    )
