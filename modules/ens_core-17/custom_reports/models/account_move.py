...
class AccountMove(models.Model):
    ...
    print_with_signature = fields.Boolean(
        ...
        default=False,
        help="Afficher la signature de l'utilisateur facture dans le "
        ...
        "500x250px avec fond transparent.",
    )
    ...
    print_with_payment_terms = fields.Boolean(
        ...
        default=True,
        help="Afficher les conditions de paiement dans la facture. "
        "Décocher pour masquer les conditions de livraison, paiement "
        "et date d'échéance.",
    )
