...
#
#############################################################################
#It's not the original model, it was edited By L
{
    'name': 'Sale Discount on Total Amount [Edited]',
    'version': '14.0.1.1.3',
...
""",
    'depends': ['sale',
                'account', 'delivery', 'ourcustom_commun_v2'
                ],
    'data': [
        'views/sale_view.xml',
...
#ourcustom_commun_v2 to check if discout >= discount minimal
